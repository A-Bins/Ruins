...
//         }
         ...
         override fun overlap(direction: String, playerLoction: Location, place: Boolean): Boolean {
             when(direction) {
                 "south" -> {
                     val loc = playerLoction.clone().add(Location(world, 2.0, 2.0, 0.0))
...
//                             Color.RED, 2F))
                     ...
                     val loc2 = playerLoction.clone().add(Location(world, -2.0, 2.0, 0.0))
                     var overlapRight = 0
                     repeat(4) {
...
//    abstract fun north(): List<Pair<Pair<Material, BlockData>, Location>>
    ...
    abstract fun overlap(direction: String, playerLoction: Location, place: Boolean): Boolean
