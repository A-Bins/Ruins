...
import com.bins.ruins.structure.enums.types.Receiver.*
import com.bins.ruins.structure.objects.utilities.Receiver.Companion.deserializeItemStack
import com.bins.ruins.structure.objects.utilities.Receiver.Companion.serializeItemStack
import com.bins.ruins.structure.objects.utilities.Receiver.Companion.tryCast
                                        ...
                                        forEach { v ->
                                            v!!.tryCast<JSONObject> {
                                                ...
                                                this["items"]!!.tryCast<JSONObject> {
                                                    ...
                                                    this.forEach { (v2, v3) ->
                                                        items["$v2".toInt()] =
                                                            if ("$v3" == "null") null else "$v3".deserializeItemStack()
                                                    }
                                                    drawers.add(
                                                        Stash.Drawer(
                                                            items,
